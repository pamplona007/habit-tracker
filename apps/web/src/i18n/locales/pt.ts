...
export const pt: TranslationKeys = {
  ...
  settings: {
    ...
    notificationsDisabled: 'Notificações desativadas no navegador',
    enableNotificationsDesc: 'Receba notificações em tempo real quando tarefas forem criadas ou concluídas',
    morningReminder: 'Lembrete Matinal',
    morningReminderDesc: 'Receba um lembrete diário sobre tarefas pendentes',
    morningReminderTime: 'Horário do lembrete',
    taskCreatedNotifications: 'Tarefa Criada',
    taskCreatedNotificationsDesc: 'Notificar quando um membro criar uma tarefa',
    taskCompletedNotifications: 'Tarefa Concluída',
    taskCompletedNotificationsDesc: 'Notificar quando um membro concluir uma tarefa',
    notificationsError: 'Falha ao atualizar notificações',
  ...
  dashboard: {
    ...
    noAnnouncements: 'Nenhum aviso ativo',
